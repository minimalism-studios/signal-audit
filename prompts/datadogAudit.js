function buildDatadogAuditPrompt(signal) {
  return `
...
Analyze this Datadog monitor alert. Do not merely summarize it. Diagnose what
the alert means operationally using only the supplied evidence. Clearly
identify uncertainty when the webhook does not contain enough context.
