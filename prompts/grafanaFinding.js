function buildGrafanaFindingPrompt(signal) {
  return `
...
Analyze the following Grafana alert.
...
{
  "auditId": "grafana-<signal-id-or-timestamp>",
...
5. Every evidence item must be traceable to the supplied Grafana alert.
